...
The systems user interface will be provided by several media like touch-screen tables and tablets. Considering the inconformity of the elderly with present-day technology the user interface will be based on simplicity. This simplicity will be outed 
